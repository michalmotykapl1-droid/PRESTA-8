...
class AzadaRawSchema
{
    public static function getColumns()
    {
        return [
            ...
            'zdjecie1linkurl' => 'text DEFAULT NULL',
            'zdjecie2linkurl' => 'text DEFAULT NULL',
            'zdjecie3linkurl' => 'text DEFAULT NULL',
            'kategoria' => 'text DEFAULT NULL',
            'jednostkapodstawowa' => 'text DEFAULT NULL',
            'waga' => 'decimal(20,6) DEFAULT 0.000000',
            'pkwiu' => 'text DEFAULT NULL',
            ...
            'masanetto' => 'decimal(20,6) DEFAULT 0.000000',
            'objetoscnetto' => 'decimal(20,6) DEFAULT 0.000000',
            'gwaranterminprzydatdni' => 'text DEFAULT NULL',
            'terminprzydataktualnypromowyprzeprzece' => 'text DEFAULT NULL',
            'eanprzepismatka' => 'text DEFAULT NULL',
            'producentnazwaiadres' => 'text DEFAULT NULL',
            'nazamowienie' => 'text DEFAULT NULL',
            'kod_cn' => 'text DEFAULT NULL',
            'krajpochodzeniaskladnikow' => 'text DEFAULT NULL',
            'objetoscbrutto' => 'decimal(20,6) DEFAULT 0.000000',
            ...
            'kodyopzbiorczych' => 'text DEFAULT NULL',
            'cenazakg' => 'decimal(20,6) DEFAULT 0.000000',
            'cenazal' => 'decimal(20,6) DEFAULT 0.000000',
