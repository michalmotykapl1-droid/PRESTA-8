 ...
 * ThemeVolty - New Product (MODIFIED: 14 Products limit fixed)
 */
...
{
    // USTAWIENIE: 14 produktów dla slidera Full Width
    ...
    public function hookdisplayHome()
    {
        ...
        if ($StatusTabSetting) {
            ...
            // UWAGA: Po zmianach w TPL trzeba czyścić cache sklepu!
    ...
    public function hookdisplayHomenewprodAjax()
    {
        if (!Cache::isStored('tvcmsnewproducts_display_home_ajax.tpl')) {
            // POPRAWKA: Przekazujemy $this->num_of_prod (14) zamiast pustego ciągu ''
            $result = $this->showFrontSideResult($this->num_of_prod, 'home_status');
            if ($result) {
