    ...
    {if $canSync}
      ...
      <div class="d-flex align-items-start justify-content-between" style="gap:12px; flex-wrap:wrap;">
        ...
        <div class="d-flex align-items-center" style="gap:10px; flex-wrap:wrap; justify-content:flex-end;">
          ...
          <label class="m-0" style="font-size:12px; user-select:none;" title="Pełna aktualizacja wszystkich pozycji (wolniejsze) — uruchamia globalną synchronizację billing dla konta w wybranym zakresie dat (pobiera i odświeża komplet wpisów).">
            <input type="checkbox" id="apBillingForce" />
            Pełna aktualizacja wszystkich pozycji
          </label>
