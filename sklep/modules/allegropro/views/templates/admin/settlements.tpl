          ...
          <div class="alpro-raw__toolbar">
            ...
            <button type="button" class="btn btn-sm btn-outline-secondary" id="alproRawApply">
              ...
              <span style="vertical-align:middle;">Pokaż</span>
	            ...
	            <div class="btn-group" role="group" aria-label="Eksport CSV">
	              <a href="#" class="btn btn-sm btn-outline-primary" id="alproRawExport" target="_blank" rel="noopener" title="Eksport CSV (lista operacji)">
	                <i class="material-icons" style="font-size:16px; vertical-align:middle;">download</i>
	                <span style="vertical-align:middle;">CSV</span>
	              </a>
	              <button type="button" class="btn btn-sm btn-outline-primary dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Wybierz wariant CSV">
	                <span class="sr-only">Wybierz wariant CSV</span>
	              </button>
	              <div class="dropdown-menu dropdown-menu-right">
	                <a href="#" class="dropdown-item" id="alproRawExportSummary" target="_blank" rel="noopener">
	                  CSV (podsumowanie)
	                </a>
	              </div>
	            </div>
