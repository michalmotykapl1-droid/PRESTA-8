<?php
/**
 * Helper dla Strefy Okazji
 * Zmiana: Filtracja stanów (tylko dostępne) bezpośrednio w SQL.
 */
...
class SpecialHelper
{
    public static function getCategoryLink($id_category)
    {
        $context = Context::getContext();
        return $context->link->getCategoryLink($id_category);
    }

    public static function getProductsForCategory($id_category, $limit = 10)
    {
        $context = Context::getContext();
        $id_lang = (int)$context->language->id;
        $id_shop = (int)$context->shop->id;

        // SQL: Pobierz produkty z kategorii, które są aktywne i MAJĄ STAN > 0
