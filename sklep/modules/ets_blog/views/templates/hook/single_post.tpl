    ...
    {if $blog_post.image}
        <div class="ets_blog_img_wrapper" itemprop="image" itemscope itemtype="http://schema.org/ImageObject">
            <div class="ets_image-single">                            
                {* --- MODYFIKACJA WEBP --- *}
<img title="{$blog_post.title|escape:'html':'UTF-8'}" src="{$blog_post.image|replace:'.jpg':'.webp'|replace:'.png':'.webp'|replace:'.jpeg':'.webp'|escape:'html':'UTF-8'}" alt="{$blog_post.title|escape:'html':'UTF-8'}" itemprop="url"/>
{* --- KONIEC --- *}
            </div>
...
<script type="application/ld+json">
{
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "{$blog_post.link|escape:'html':'UTF-8'}"
  },
  "headline": "{$blog_post.title|escape:'html':'UTF-8'}",
  "description": "{$blog_post.meta_description|escape:'html':'UTF-8'}",
  "image": "{$blog_post.image|escape:'html':'UTF-8'}",
  "author": {
    "@type": "Person",
    "name": "{if isset($blog_post.employee.name)}{$blog_post.employee.name|escape:'html':'UTF-8'}{/if}",
    "url": "{$blog_post.author_link|escape:'html':'UTF-8'}"
  },
  "publisher": {
    "@type": "Organization",
    "name": "{Configuration::get('PS_SHOP_NAME')|escape:'html':'UTF-8'}",
    "url": "{$base_dir|escape:'html':'UTF-8'}",
    "logo": {
      "@type": "ImageObject",
      "url": "{$ets_blog_config.ETS_BLOG_SHOP_URI|escape:'html':'UTF-8'}img/{Configuration::get('PS_LOGO')|escape:'html':'UTF-8'}"
    }
  },
  "datePublished": "{$blog_post.date_add|date_format:'%Y-%m-%d'}",
  "dateModified": "{$blog_post.date_upd|date_format:'%Y-%m-%d'}"
}
</script>
    ...
    {if $blog_post}
        ...
        <div class="post-details">
            ...
            </div>                  <div class="blog-medical-disclaimer">
            <p>
                <span class="medical-disclaimer-icon">&#9432;</span>
            ...
            <div class="blog_description">
                ...
                {/if}
{if isset($blog_post.faq_content) && $blog_post.faq_content}
<section class="blog-faq">
  <h2>Najczęściej zadawane pytania (FAQ)</h2>
  <div class="faq-content">
    {$blog_post.faq_content nofilter}
  </div>
</section>
{/if} 
{if isset($blog_post.sources_content) && $blog_post.sources_content}
  <section class="blog-sources">
    <h2></h2>
    <div class="sources-content">
      {$blog_post.sources_content nofilter}
    </div>
  </section>
{/if}
           </div>
            ...
            {/if}
{* --- POCZĄTEK KODU DLA PRZYCISKÓW UDOSTĘPNIANIA NA FB --- *}
            <div class="ets_blog_button_share">
                <ul>
                    <li class="facebook">
                        <a href="https://www.facebook.com/sharer/sharer.php?u={$blog_post.link|urlencode}" target="_blank" rel="noopener noreferrer">
                            <i class="fab fa-facebook"></i> Udostępnij na Facebook
                        </a>
                    </li>
			<li class="whatsapp">
      <a href="https://api.whatsapp.com/send?text=Zobacz%20ten%20artyku%C5%82%3A%20{$blog_post.link|urlencode}" target="_blank" rel="noopener noreferrer">
        <i class="fab fa-whatsapp"></i> Udostępnij na WhatsApp
      </a>
    </li>
                   {* Możesz dodać inne media społecznościowe, jeśli są potrzebne i ostylowane w module *}
                    {*
                    <li class="twitter">
                        <a href="https://twitter.com/share?url={$blog_post.link|urlencode}" target="_blank" rel="noopener noreferrer">
                            <i class="fa fa-twitter"></i> Twitter
                        </a>
                    </li>
                    <li class="pinterest">
                        <a href="https://pinterest.com/pin/create/button/?url={$blog_post.link|urlencode}&media={$blog_post.image|urlencode}&description={$blog_post.title|urlencode}" target="_blank" rel="noopener noreferrer">
            ...
            {* --- KONIEC KODU DLA PRZYCISKÓW UDOSTĘPNIANIA NA FB --- *}
                            ...
                            <li class="ets-blog-related-posts-list-li col-xs-12 col-sm-4 col-lg-{12/$post_row|intval} thumbnail-container">
                                {if $rpost.thumb}
                                    <a class="ets_item_img" href="{$rpost.link|escape:'html':'UTF-8'}">
                                        {* --- MODYFIKACJA WEBP --- *}
<img src="{$rpost.thumb|replace:'.jpg':'.webp'|replace:'.png':'.webp'|replace:'.jpeg':'.webp'|escape:'html':'UTF-8'}" alt="{$rpost.title|escape:'html':'UTF-8'}" />
{* --- KONIEC --- *}
                                    </a>                                                
                                {/if}
