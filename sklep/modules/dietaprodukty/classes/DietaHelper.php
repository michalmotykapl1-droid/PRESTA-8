<?php
/**
 * Helper dla Modułu Dieta (Filtrowanie Dostępności)
 */
...
class DietaHelper
{
    public static function getProductsForCategory($id_category, $limit = 15)
    {
        $context = Context::getContext();
        $id_lang = (int)$context->language->id;
        $id_shop = (int)$context->shop->id;

        // Pobieramy kategorię i jej podkategorie (drzewo)
