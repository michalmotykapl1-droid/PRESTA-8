...
private function extractPostedCategoryIds()
    {
        // Preferujemy nowy, stabilny picker (wyszukiwarka + chipy), który przekazuje wybrane ID w JSON.
        // Dzięki temu usuwanie kategorii w edycji działa zawsze poprawnie, niezależnie od kontrolek drzewa.
        $json = trim((string)Tools::getValue('azada_selected_categories_json', ''));
        if ($json !== '') {
