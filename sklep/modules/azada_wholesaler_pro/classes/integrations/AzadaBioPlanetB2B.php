...
class AzadaBioPlanetB2B
{
    ...
    public function scrapeOrders($login, $password)
    {
        ...
        $daysBack = AzadaConfig::getInt('AZADA_B2B_DAYS_RANGE', 7);
    ...
    public function scrapeInvoices($login, $password)
    {
        ...
        // 2. Budowanie URL
        $daysBack = AzadaConfig::getInt('AZADA_FV_DAYS_RANGE', 30);
    ...
    private function parseHtmlTable($html)
    {
        ...
        $strategy = AzadaConfig::getString('AZADA_B2B_FETCH_STRATEGY', 'strict');
