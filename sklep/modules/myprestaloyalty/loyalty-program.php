...
/* --- POPRAWKA: Data ważności pobierana z ustawień modułu --- */
    ...
    if ($validity_period > 0) {
        // Przeliczamy dni na sekundy (dzień * 24h * 60m * 60s)
        $cartRule->date_to = date('Y-m-d H:i:s', $dateFrom + ($validity_period * 86400));
    } else {
        $cartRule->date_to = date('Y-m-d H:i:s', $dateFrom + (180 * 86400)); // Domyślnie 180 dni
    }
    /* ----------------------------------------------------------- */
