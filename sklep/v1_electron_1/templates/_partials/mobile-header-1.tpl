        ...
        <div class='tvcmsmobile-header-menu-offer-text tvcmsheader-sticky'>
            <div class="tvcmsmobile-header-menu col-md-1 col-sm-12 col-xs-2">
                ...
                <div class="tvmobile-slidebar">
                    ...
                    {* --- EDYCJA: WSTAWIONE DRZEWO KATEGORII Z ODPOWIEDNIM HOOKIEM --- *}
                    <div id="mobile-category-tree-container" class="mobile-category-tree">
                        {widget name="ps_categorytree" hook='displayMegamenuMobile'}
                    </div>
                    {* --- KONIEC EDYCJI --- *}
                            ...
                            <div class="tv-account-wrapper">
                                <button class="btn-unstyle tv-myaccount-btn tv-myaccount-btn-desktop" name="User Icon" aria-label="User Icon">
                                    <svg version="1.1" id="Layer_1" x="0px" y="0px" width="30.932px" height="31.088px" viewBox="0 0 30.932 31.088" xml:space="preserve">
                                        <g>
                                            <path style="fill:none;stroke:#000000;stroke-width:0.55;stroke-miterlimit:10;" d="M15.444,17.898 c7.457,0,13.596,5.579,14.509,12.789h0.513c-1.226-7.997-7.473-13.061-15.001-13.061c-7.528,0-13.776,5.063-14.999,13.061h0.47 C1.848,23.479,7.987,17.898,15.444,17.898z"></path>
                                            <path style="fill:#FFD742;" d="M15.466,17.151c-4.23,0-7.67-3.438-7.67-7.668c0-4.231,3.44-7.671,7.67-7.671 c4.232,0,7.67,3.439,7.67,7.671C23.136,13.714,19.698,17.151,15.466,17.151"></path>
