    ...
    <div class="card-header">
      <div class="alpro-head" style="display:flex; justify-content:space-between; align-items:center; gap:10px; flex-wrap:wrap;">
        <div class="title">
          ...
          <span class="alpro-badge" title="Widok audytowy: surowy dziennik operacji (payments/payment-operations) z cache DB. Daty dotyczą occurredAt.">Dziennik (RAW)</span>
        </div>
        ...
        <div class="btn-group" role="group">
          ...
          <a class="btn btn-default" href="{$view_payout_url|escape:'htmlall':'UTF-8'}"><i class="material-icons" style="font-size:18px; vertical-align:middle;">account_balance_wallet</i> Wypłaty (PAYOUT)</a>
